...
const Nav = () => {
  ...
  return (
    <div>
      ...
      <div
        id="mobileNav"
        className={`fixed left-0 top-0 z-50 flex h-full w-full flex-col items-center justify-center bg-primary text-4xl transition-all ${showMobileNav ? "z-30 opacity-100" : "pointer-events-none opacity-0"
          }`}
      >
      ...
      <Icon
        ...
        className={`fixed bottom-8 left-1/2 z-[999] -translate-x-1/2 rounded-full bg-primary p-4 transition-all ${showMobileNav ? "bg-secondary text-base-100" : "bg-base-100"
          } text-4xl md:hidden`}
